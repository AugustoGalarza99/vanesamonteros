...
const handleCancelarTurno = async () => {
    ...
    return (
        <div className="estado-peluquero">
            ...
            <p className='p-estado'>En esta seccion podras consultar la informacion sobre tu turno y el estado del profesional. Si esta con demora ingresando tu DNI te informaremos la hora aproximada de tu servicio, tambien podras cancelar tu turno hasta un maximo de 4 horas antes del mismo</p>
            <input
